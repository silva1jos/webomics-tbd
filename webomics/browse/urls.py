...
urlpatterns = [path('', views.IndexView.as_view(), name='index'),
               ...
               path('<int:pk>/fold_change', views.FoldChangeView.as_view(),
                    name='fc_detail'),
               ...
               path('ajax/<int:pk>/load_pca', views.load_pca,
                    name='ajax_load_pca'),
               path('ajax/<int:pk>/load_fc', views.load_fc,
                    name='ajax_load_fc'),
               path('ajax/<int:pk>/filter_details', views.filter_details,
                    name='ajax_filter_details'),
